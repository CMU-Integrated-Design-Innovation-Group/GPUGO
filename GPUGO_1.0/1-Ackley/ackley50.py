...
'''
Python script "auckley50.py” finds the global minimum of the Ackley function 
...
function is set as 50 in this script. In other words, the Ackley function has 
50 variables, and the value of each variable belongs to the range [-35, 40]. 
...
def ackleyValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    d = 50 # The number of variables in the Ackley function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 50 # The number of variables in the Ackley function
...
# the 50 variables in the Ackley function. 

initialRegion = np.tile([-35, 40], 50)
...
# Initialize the maximum cycling index for the Ackley function with 50 
# variables
maximumCyc = 41
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Ackley function:", 50)
