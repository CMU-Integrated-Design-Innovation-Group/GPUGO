...
'''
Python script "auckley100.py” finds the global minimum of the Ackley function 
...
function is set as 100 in this script. In other words, the Ackley function has 
100 variables, and the value of each variable belongs to the range [-35, 40]. 
...
def ackleyValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    in the function F(X), where i = 1, 2, … n. In this script, n = d = 100.
    ...
    d = 100 # The number of variables in the Ackley function
...
def ackleySample_IA (xValIA, pos, num, cycleIdx):
    ...
    function F(X), where i belongs to {1, 2, …, n}. In this script, n = d = 100.
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 100 # The number of variables in the Ackley function
...
# the 100 variables in the Ackley function. 

initialRegion = np.tile([-35, 40], 100)
...
# Initialize the maximum cycling index for the Ackley function with 100 
# variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Ackley function:", 100)
