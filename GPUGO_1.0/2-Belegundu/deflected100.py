...
'''
Python script "deflected100.py” finds the global minimum of the Deflected 
...
dimension of the Deflected Corrugated Spring function is set as 100 in this 
script. In other words, the Deflected Corrugated Spring function has 100 
...
# the 100 variables in the Deflected Corrugated Spring function. 
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Deflected Corrugated Spring function:", 100)
