...
'''
Python script "deflected50.py” finds the global minimum of the Deflected 
...
dimension of the Deflected Corrugated Spring function is set as 50 in this 
script. In other words, the Deflected Corrugated Spring function has 50 
...
# the 50 variables in the Deflected Corrugated Spring function. 
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Deflected Corrugated Spring function:", 50)
