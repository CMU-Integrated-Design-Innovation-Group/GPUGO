...
'''
Python script "Levy2000.py” finds the global minimum of the Levy function using 
...
function has 10 variables (n = 2000) in this script, and the value of each 
...
def LevyValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    function F(X), where i belongs to {1, 2, …, n}. In this script, n = 2000.
    ...
    n = 2000 # The number of variables in the Levy function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 2000 # The number of variables in the Levy function
...
# Define a NumPy array that represents the 2000-dimensional search domain. 
# The NumPy array is initialized by the lower and upper bounds for the value of 
# the 2000 variables in the Levy function. 

initialRegion = np.tile([-10, 10], 2000)
...
# Initialize the maximum cycling index for the Levy function with 2000 variables
maximumCyc = 1991
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Levy function:", 2000)
