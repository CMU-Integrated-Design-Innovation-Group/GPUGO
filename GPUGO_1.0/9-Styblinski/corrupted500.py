...
'''
Python script "corrupted500.py” finds the global minimum of the Multimodal 
...
the Multimodal Corrupted Convex Quadratic function is set as 500 in this 
script. In other words, the Multimodal Corrupted Convex Quadratic function has 
500 variables, and the value of each variable belongs to the range [-10, 11]. 
...
# the 500 variables in the Multimodal Corrupted Convex Quadratic function. 

initialRegion = np.tile([-10, 11], 500)
...
# Quadratic function with 500 variables
maximumCyc = 491
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Multimodal Corrupted Convex Quadratic function:", 500)
