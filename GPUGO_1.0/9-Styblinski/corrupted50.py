...
'''
Python script "corrupted50.py” finds the global minimum of the Multimodal 
...
the Multimodal Corrupted Convex Quadratic function is set as 50 in this 
script. In other words, the Multimodal Corrupted Convex Quadratic function has 
50 variables, and the value of each variable belongs to the range [-10, 11]. 
...
# the 50 variables in the Multimodal Corrupted Convex Quadratic function. 

initialRegion = np.tile([-10, 11], 50)
...
# Quadratic function with 50 variables
maximumCyc = 41
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Multimodal Corrupted Convex Quadratic function:", 50)
