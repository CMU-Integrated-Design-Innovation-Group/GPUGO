...
'''
Python script "rastrigin100.py” finds the global minimum of the Rastrigin 
...
Rastrigin function is set as 100 in this script. In other words, the Rastrigin 
...
When the iterative process is halted, the 100-dimensional region(s) that satisfy 
...
def rastriginValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 100 # The number of variables in the Rastrigin function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 100 # The number of variables in the Rastrigin function
...
# the 100 variables in the Rastrigin function. 

initialRegion = np.tile([-5.5, 6], 100)
...
# Initialize the maximum cycling index for the Rastrigin function with 100 
# variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Rastrigin function:", 100)
