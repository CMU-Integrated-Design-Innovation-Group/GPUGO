...
'''
Python script "rastrigin500.py” finds the global minimum of the Rastrigin 
...
Rastrigin function is set as 500 in this script. In other words, the Rastrigin 
...
When the iterative process is halted, the 500-dimensional region(s) that satisfy 
...
def rastriginValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 500 # The number of variables in the Rastrigin function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 500 # The number of variables in the Rastrigin function
...
# the 500 variables in the Rastrigin function. 

initialRegion = np.tile([-5.5, 6], 500)
...
# Initialize the maximum cycling index for the Rastrigin function with 500 
# variables
maximumCyc = 491
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Rastrigin function:", 500)
