...
'''
Python script "IARastrigin.py” implements the basic interval arithmetic 
operations on GPU-based devices for interval evaluation of the Rastrigin 
Function [1].
...
Reference:
[1] Rastrigin, L. A. 1974. Extremal Control Systems. Theoretical Foundations of 
Engineering Cybernetics Series. 3.
