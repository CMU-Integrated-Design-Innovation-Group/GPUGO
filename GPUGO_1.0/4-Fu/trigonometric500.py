...
'''
Python script "trigonometric500.py” finds the global minimum of the 
...
Trigonometric function is set as 500 in this script. In other words, the 
Trigonometric function has 500 variables, and the value of each variable 
...
def trigonometricValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 500 # The number of variables in the Trigonometric function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 500 # The number of variables in the Trigonometric function
...
# the 500 variables in the Trigonometric function. 
...
# Initialize the maximum cycling index for the Trigonometric function with 500 
# variables
maximumCyc = 491
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Trigonometric function:", 500)
