...
'''
Python script "trigonometric100.py” finds the global minimum of the 
...
Trigonometric function is set as 100 in this script. In other words, the 
Trigonometric function has 100 variables, and the value of each variable 
...
def trigonometricValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 100 # The number of variables in the Trigonometric function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 100 # The number of variables in the Trigonometric function
...
# the 100 variables in the Trigonometric function. 

initialRegion = np.tile([-10, 10], 100)
...
# Initialize the maximum cycling index for the Trigonometric function with 100 
# variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Trigonometric function:", 100)
