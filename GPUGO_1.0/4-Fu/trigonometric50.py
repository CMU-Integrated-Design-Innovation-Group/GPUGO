...
'''
Python script "trigonometric50.py” finds the global minimum of the 
...
Trigonometric function is set as 50 in this script. In other words, the 
Trigonometric function has 50 variables, and the value of each variable 
...
def trigonometricValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 50 # The number of variables in the Trigonometric function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 50 # The number of variables in the Trigonometric function
...
# the 50 variables in the Trigonometric function. 

initialRegion = np.tile([-10, 10], 50)
...
# Initialize the maximum cycling index for the Trigonometric function with 50 
# variables
maximumCyc = 41
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Trigonometric function:", 50)
