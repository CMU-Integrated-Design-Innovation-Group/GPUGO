...
'''
Python script "IATrigonometric.py” implements the basic interval arithmetic 
operations on GPU-based devices for interval evaluation of the Trigonometric 
Function [1].
...
Reference:
[1] Fu, M. C., Hu, J., & Marcus, S. I. 2006. Model-Based Randomized Methods for 
Global Optimization. In Proceedings of the 17th International Symposium on 
