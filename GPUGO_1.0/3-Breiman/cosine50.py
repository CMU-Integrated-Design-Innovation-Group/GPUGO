...
'''
Python script "cosine50.py” finds the global minimum of the Cosine Mixture 
...
as 50 in this script. In other words, the Cosine Mixture function has 50 
...
def cosineValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 50 # The number of variables in the Cosine Mixture function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 50 # The number of variables in the Cosine Mixture function
...
# the 50 variables in the Cosine Mixture function. 

initialRegion = np.tile([-1, 2], 50)
...
# Initialize the maximum cycling index for the Cosine Mixture function with 50 
# variables
maximumCyc = 41
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Cosine Mixture function:", 50)
