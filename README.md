...
## Environment
The Python scripts included in the folder “GPUGO_1.0” have been compiled and executed successfully in the following environment:
- Python 3.13.2
- CUDA	12.8
- NumPy	2.1.3
- Numba	0.61.0
...
## Citation
Please cite the following arXiv preprint in your publications if the GPUGO project helps your research. 

Zhang, G., Shan, Q., Cagan, J.: GPU-based complete search for nonlinear minimization subject to bounds. arXiv Preprint, arXiv:2507.01770 (2025). https://doi.org/10.48550/arXiv.2507.01770

The paper could also be accessed through the author's ResearchGate page ([link](https://www.researchgate.net/publication/393333736_GPU-Based_Complete_Search_for_Nonlinear_Minimization_Subject_to_Bounds)).
