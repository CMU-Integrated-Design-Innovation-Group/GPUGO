...
'''
Python script "sinusoidal500.py” finds the global minimum of the Sinusoidal 
...
2005 [1]. The dimension of the Sinusoidal function is set as 500 in this 
script. In other words, the Sinusoidal function has 500 variables, and the 
...
def sinusoidalValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 500 # The number of variables in the Sinusoidal function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 500 # The number of variables in the Sinusoidal function
...
# the 500 variables in the Sinusoidal function. 

initialRegion = np.tile([0, math.pi], 500)
...
# Initialize the maximum cycling index for the Sinusoidal function with 500 
# variables
maximumCyc = 491
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Sinusoidal function:", 500)
