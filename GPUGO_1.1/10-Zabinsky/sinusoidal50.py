...
'''
Python script "sinusoidal50.py” finds the global minimum of the Sinusoidal 
...
2005 [1]. The dimension of the Sinusoidal function is set as 50 in this 
script. In other words, the Sinusoidal function has 50 variables, and the 
...
def sinusoidalValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 50 # The number of variables in the Sinusoidal function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 50 # The number of variables in the Sinusoidal function
...
# the 50 variables in the Sinusoidal function. 

initialRegion = np.tile([0, math.pi], 50)
...
# Initialize the maximum cycling index for the Sinusoidal function with 50 
# variables
maximumCyc = 41
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Sinusoidal function:", 50)
