...
'''
Python script "sinusoidal100.py” finds the global minimum of the Sinusoidal 
...
2005 [1]. The dimension of the Sinusoidal function is set as 100 in this 
script. In other words, the Sinusoidal function has 100 variables, and the 
...
def sinusoidalValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 100 # The number of variables in the Sinusoidal function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 100 # The number of variables in the Sinusoidal function
...
# the 100 variables in the Sinusoidal function. 

initialRegion = np.tile([0, math.pi], 100)
...
# Initialize the maximum cycling index for the Sinusoidal function with 100 
# variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Sinusoidal function:", 100)
