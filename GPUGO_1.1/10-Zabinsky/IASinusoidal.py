...
'''
Python script "IASinusoidal.py” implements the basic interval arithmetic 
operations on GPU-based devices for interval evaluation of the Sinusoidal
Function [1].
...
Reference:
[1] Ali, M.M., Khompatraporn, C. & Zabinsky, Z.B. 2005. A Numerical Evaluation 
of Several Stochastic Algorithms on Selected Continuous Global Optimization Test 
Problems. J Glob Optim. 31, 635-672. 
