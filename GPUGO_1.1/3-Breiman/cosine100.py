...
'''
Python script "cosine100.py” finds the global minimum of the Cosine Mixture 
...
as 100 in this script. In other words, the Cosine Mixture function has 100 
...
def cosineValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 100 # The number of variables in the Cosine Mixture function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 100 # The number of variables in the Cosine Mixture function
...
# the 100 variables in the Cosine Mixture function. 

initialRegion = np.tile([-1, 2], 100)
...
# Initialize the maximum cycling index for the Cosine Mixture function with 100 
# variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Cosine Mixture function:", 100)
