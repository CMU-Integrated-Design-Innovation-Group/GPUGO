...
'''
Python script "cosine500.py” finds the global minimum of the Cosine Mixture 
...
as 500 in this script. In other words, the Cosine Mixture function has 500 
...
def cosineValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 500 # The number of variables in the Cosine Mixture function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 500 # The number of variables in the Cosine Mixture function
...
# the 500 variables in the Cosine Mixture function. 

initialRegion = np.tile([-1, 2], 500)
...
# Initialize the maximum cycling index for the Cosine Mixture function with 500 
# variables
maximumCyc = 491
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Cosine Mixture function:", 500)
