...
'''
Python script "rosenbrock100.py” finds the global minimum of the Rosenbrock
...
Y. H. Qiu [2]. The dimension of the Rosenbrock Function is set as 100 in 
this script. In other words, the Rosenbrock Function has 100 variables, and 
...
When the iterative process is halted, the 100-dimensional region(s) that 
...
def rosenbrockValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    in the function F(X), where i = 1, 2, … n. In this script, n = 100.
...
def rosenbrockSample_IA (xValIA, pos, num, cycleIdx):
    ...
    function F(X), where i belongs to {1, 2, …, n}. In this script, n = 100.
...
# Define a NumPy array that represents the 100-dimensional search domain. 
# The NumPy array is initialized by the lower and upper bounds for the value of 
# the 100 variables in the Rosenbrock Function. 

initialRegion = np.tile([-30, 30], 100)
...
# Initialize the maximum cycling index for the Rosenbrock Function with 100 
# variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Rosenbrock Function:", 100)
