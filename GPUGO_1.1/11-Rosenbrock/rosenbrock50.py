...
'''
Python script "rosenbrock50.py” finds the global minimum of the Rosenbrock
...
Y. H. Qiu [2]. The dimension of the Rosenbrock Function is set as 50 in 
this script. In other words, the Rosenbrock Function has 50 variables, and 
...
def rosenbrockValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    in the function F(X), where i = 1, 2, … n. In this script, n = 50.
...
def rosenbrockSample_IA (xValIA, pos, num, cycleIdx):
    ...
    function F(X), where i belongs to {1, 2, …, n}. In this script, n = 50.
...
# the 50 variables in the Rosenbrock Function. 

initialRegion = np.tile([-30, 30], 50)
...
# Initialize the maximum cycling index for the Rosenbrock Function with 50 
# variables
maximumCyc = 41
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Rosenbrock Function:", 50)
