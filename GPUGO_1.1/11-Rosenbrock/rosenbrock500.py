...
'''
Python script "rosenbrock500.py” finds the global minimum of the Rosenbrock
...
Y. H. Qiu [2]. The dimension of the Rosenbrock Function is set as 500 in 
this script. In other words, the Rosenbrock Function has 500 variables, and 
...
When the iterative process is halted, the 500-dimensional region(s) that 
...
def rosenbrockValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    in the function F(X), where i = 1, 2, … n. In this script, n = 500.
...
# the 500 variables in the Rosenbrock Function. 

initialRegion = np.tile([-30, 30], 500)
...
# Initialize the maximum cycling index for the Rosenbrock Function with 500 
# variables
maximumCyc = 491
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Rosenbrock Function:", 500)
