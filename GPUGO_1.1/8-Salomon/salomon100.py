...
'''
Python script "salomon100.py” finds the global minimum of the Salomon 
...
Salomon function is set as 100 in this script. In other words, the Salomon 
...
def salomonValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    d = 100 # The number of variables in the Salomon function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 100 # The number of variables in the Salomon function
...
# the 100 variables in the Salomon function. 
...
# Initialize the maximum cycling index for the Salomon function with 100 
# variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Salomon function:", 100)
