...
'''
Python script "IAAckley.py” implements the basic interval arithmetic operations 
on GPU-based devices for interval evaluation of the Ackley Function [1].
...
Reference:
[1] Bäck, Thomas & Schwefel, Hans-Paul, (1993) "An Overview of Evolutionary 
...
def minus(lower1, upper1, lower2, upper2):
    ...
    '''
    The function "minuns" implements the interval arithmetic operation of 
...
def exp(lower, upper):
    ...
    '''
    lowerOut = math.exp(lower)
    upperOut = math.exp(upper)
    return outRound(lowerOut, upperOut, n)