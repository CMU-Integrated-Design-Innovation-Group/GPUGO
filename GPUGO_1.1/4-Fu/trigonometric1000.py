...
'''
Python script "trigonometric1000.py” finds the global minimum of the 
Trigonometric function using a GPU-based global optimization method. The 
Trigonometric function F(X) is introduced in the work "Model-Based Randomized 
Methods for Global Optimization" in 2006 [1]. The dimension of the 
Trigonometric function is set as 1000 in this script. In other words, the 
Trigonometric function has 1000 variables, and the value of each variable 
belongs to the range [-10, 10].
...
each subregion, and interval evaluation of the Trigonometric function is 
performed at each sample point. The smallest upper bound for the value of the 
Trigonometric function among all sample points is used to update the upper 
bound of the global minimum of the Trigonometric function. 
...
Notably, for the Trigonometric function with more than 10 variables, a variable 
...
rounding in the module IATrigonometric, the result of this script has 15 or 
fewer significant digits. 

Reference:
[1] Fu, M. C., Hu, J., & Marcus, S. I., (2006) Model-Based Randomized Methods 
for Global Optimization. In Proceedings of the 17th International Symposium on
Mathematical Theory of Networks and Systems, 355-363. ACM Press, Kyoto, Japan.

'''

from numba import cuda
import numpy as np
import IATrigonometric as ia
import math
import time
...
'''
================================================================================
Device functions: trigonometricValue_IA, trigonometricSample_IA, 
trigonometricDerivative_IA, and selectVarInSubRegion.
================================================================================
''' 

@cuda.jit(device=True)
def trigonometricValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    
    '''
    The device function "trigonometricValue_IA" is called by the kernel function 
    “ruleOutGPU”. The device function computes the lower and upper bounds for 
    the value of the Trigonometric function which determines if a subregion 
    should be ruled out using a code list. A code list defines the sequence of 
    interval arithmetic operations to evaluate the function. The bounds for 
    variables within the subregion in the function F(X) are calculated based on 
    the absolute position of the thread in the grid in GPU computing and the 
    cycling index of the selected region. After the evaluation process using 
    the code list, the computed lower bound for the value of the function that
    belongs to the subregion is compared with the smallest upper bound for the 
    global minimum to decide if the subregion should be ruled out from the 
    space. Specifically, if the lower bound is smaller than or equal to the 
    smallest upper bound, the subregion should be kept with the flag value of 
    0. If the lower bound is larger than the smallest upper bound, the 
    subregion should be ruled out with the flag value of 1. 
    ...
    The upper bound of the global minimum of the Trigonometric function F(X).
    ...
    -------
    fMin: numpy.float64
    The lower bound for the value of the Trigonometric function F(X) in the 
    subregion.
    flag: int32
    The flag equals 0 if the subregion is not ruled out. The flag equals 1 if 
    the subregion is ruled out.
    ...
    n = 1000 # The number of variables in the Trigonometric function

    # Interval evaluation of the Trigonometric function in the subregion
    
    # Initialize the sum of terms within the summation sign of 
    # 8(sin⁡[7(x_i-0.9)^2])^2 + 6(sin⁡[14(x_i-0.9)^2])^2 + (x_i-0.9)^2
    fsMin, fsMax = 0, 0 

    # Compute the sum of terms within the summation sign of 
    # 8(sin⁡[7(x_i-0.9)^2])^2 + 6(sin⁡[14(x_i-0.9)^2])^2 + (x_i-0.9)^2
    for i in range (1, n + 1):
        ...
        # F_s1 = x_i - 0.9 operation in the code list
        fsMinTemp, fsMaxTemp = ia.plus(lowerX, upperX, -0.9)
        # F_s2 = (F_s1) ^ 2 operation in the code list
        fsMinTemp, fsMaxTemp = ia.power(fsMinTemp, fsMaxTemp, 2)
        
        # F_s3 = 7 (F_s2) operation in the code list
        fsMinCur, fsMaxCur = ia.times(fsMinTemp, fsMaxTemp, 7)
        # F_s4 = sin (F_s3) operation in the code list
        fsMinCur, fsMaxCur = ia.sine(fsMinCur, fsMaxCur)
        # F_s5 = (F_s4) ^ 2 operation in the code list
        fsMinCur, fsMaxCur = ia.power(fsMinCur, fsMaxCur, 2)
        # F_s6 = 8 (F_s5) operation in the code list
        fsMinCur, fsMaxCur = ia.times(fsMinCur, fsMaxCur, 8)   
          
        # F_s7 = 14 (F_s2) operation in the code list
        fsMinCur2, fsMaxCur2 = ia.times(fsMinTemp, fsMaxTemp, 14)
        # F_s8 = sin (F_s7) operation in the code list
        fsMinCur2, fsMaxCur2 = ia.sine(fsMinCur2, fsMaxCur2)
        # F_s9 = (F_s8) ^ 2 operation in the code list
        fsMinCur2, fsMaxCur2 = ia.power(fsMinCur2, fsMaxCur2, 2)
        # F_s10 = 6 (F_s9) operation in the code list
        fsMinCur2, fsMaxCur2 = ia.times(fsMinCur2, fsMaxCur2, 6)   

        # F_s11 = F_s10 + F_s12 operation in the code list
        fsMinCur, fsMaxCur = ia.add(fsMinCur2, fsMaxCur2, fsMinCur, fsMaxCur) 
        
        # F_s12 = F_s11 + F_s2 operation in the code list
        fsMinCur, fsMaxCur = ia.add(fsMinTemp, fsMaxTemp, fsMinCur, fsMaxCur)   
         
        # F_1 = sum (F_s12) operation in the code list
        fsMin, fsMax = ia.add(fsMin, fsMax, fsMinCur, fsMaxCur)  
    # F_2 = 1 + F_1 operation in the code list
    fMin, fMax = ia.plus(fsMin, fsMax, 1)      
...
@cuda.jit(device=True)
def trigonometricSample_IA (xValIA, pos, num, cycleIdx):
    
    '''
    The device function "trigonometricSample_IA" is called by the kernel 
    function “sampling”. The device function "trigonometricSample_IA" samples 
    over a subregion and derives the smallest upper bound for the value of the 
    Trigonometric function among all sample points in the subregion. 
    Specifically, the bounds for the value of each variable within the 
    subregion (the position of the subregion) are first calculated using the 
    absolute position of the thread in the grid that corresponds to the 
    subregion, the bounds for the value of each variable within the selected 
    region (the position of the selected region), and the cycling index of the 
    selected region. User-specified number of sample points are uniformly 
    chosen along the diagonal of the subregion, where the diagonal connects the 
    two vertices of the subregion with the coordinates of lower bounds and 
    upper bounds for all variables, respectively. The lower and upper bounds 
    for the value of the Trigonometric function at each sample point are then 
    computed using interval arithmetic. The smallest upper bound for the value 
    of the Trigonometric function among all sample points is returned as the 
    result. 
    ...
    -------
    fMax: numpy.float64
    The smallest upper bound for the value of the Trigonometric function among 
    all sample points in the subregion.
    ...
    for j in range (0, num):
        ...
        for i in range (1, n + 1):
            ...
            # F_s1 = x_i - 0.9 operation in the code list
            fsMinTemp, fsMaxTemp = ia.plus(stepCurr, stepCurr, -0.9)
            # F_s2 = (F_s1) ^ 2 operation in the code list
            fsMinTemp, fsMaxTemp = ia.power(fsMinTemp, fsMaxTemp, 2)
        ...
        # value of the Trigonometric function among all sample points within the 
        # subregion
        if (j == 0):
            ...
            # the value of the Trigonometric function among all sample points in 
            # the subregion
            if (fMaxOut > fMax):
                fMaxOut = fMax
...
@cuda.jit(device=True)
def trigonometricDerivative_IA (xdIA, pos, flagVal, cycleIdx):
    
    '''
    Device function "trigonometricDerivative_IA" is called by the kernel 
    function “ruleOutGPU”. The device function checks the generalized KKT 
    conditions for all the variables in a subregion and determines whether the 
    subregion should be ruled out. Specifically, since the first order 
    derivative of the objective function to any of the variables does not equal 
    zero in the search domain of the optimization problem, the device function 
    checks whether any of the related bound constraints could be active for 
    each of these variables. If the bound constraint of one variable cannot be 
    active, the subregion is ruled out. Otherwise, the subregion is not ruled 
    out.
    ...
    # Calculate the first order derivatives of the Trigonometric Function            
    for j in range (1, n + 1):
        lowerX, upperX = selectVarInSubRegion (xdIA, j, pos, cycleIdx)
        
        dfMin, dfMax = 0, 0

        # F_1 = x_i - 0.9 operation in the code list
        fdMinTemp, fdMaxTemp = ia.plus(lowerX, upperX, -0.9)
        # F_2 = (F_1) ^ 2 operation in the code list
        fdMinTemp2, fdMaxTemp2 = ia.power(fdMinTemp, fdMaxTemp, 2) 
        
        # F_3 = 7 F_2 operation in the code list
        df3Min, df3Max = ia.times(fdMinTemp2, fdMaxTemp2, 7) 
        # F_4 = sin (F_s3) operation in the code list
        dfMin, dfMax = ia.sine(df3Min, df3Max)    
        # F_5 = cos (F_s3) operation in the code list
        df3Min, df3Max = ia.cosine(df3Min, df3Max)   
        # F_6 = F_4 * F_5 operation in the code list
        dfMin, dfMax = ia.multiply(dfMin, dfMax, df3Min, df3Max)    
        # F_7 = F_6 * F_1 operation in the code list
        dfMin, dfMax = ia.multiply(dfMin, dfMax, fdMinTemp, fdMaxTemp)       
        # F_8 = 224 F_7 operation in the code list
        dfMin, dfMax = ia.times(dfMin, dfMax, 224) 
        
        # F_9 = 14 F_2 operation in the code list
        df3Min, df3Max = ia.times(fdMinTemp2, fdMaxTemp2, 14) 
        # F_10 = sin (F_s9) operation in the code list
        df10Min, df10Max = ia.sine(df3Min, df3Max)    
        # F_11 = cos (F_s9) operation in the code list
        df3Min, df3Max = ia.cosine(df3Min, df3Max)   
        # F_12 = F_10 * F_11 operation in the code list
        df10Min, df10Max = ia.multiply(df10Min, df10Max, df3Min, df3Max)    
        # F_13 = F_12 * F_1 operation in the code list
        df10Min, df10Max = ia.multiply(df10Min, df10Max, fdMinTemp, fdMaxTemp)       
        # F_14 = 336 F_13 operation in the code list
        df10Min, df10Max = ia.times(df10Min, df10Max, 336)     
        
        # F_15 = F_14 + F_8 operation in the code list
        dfMin, dfMax = ia.add(dfMin, dfMax, df10Min, df10Max)    
        # F_16 = 2 F_1 operation in the code list
        df10Min, df10Max = ia.times(fdMinTemp, fdMaxTemp, 2) 
        # F_17 = F_16 + F_15 operation in the code list
        dfMin, dfMax = ia.add(dfMin, dfMax, df10Min, df10Max)   

        # Check the derivative to determine if the subregion could be ruled out
        if (dfMin > 0 and lowerX != -10):
            flag = 1
            return flag
        elif (dfMax < 0 and upperX != 10):
            flag = 1
            return flag
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    "trigonometricValue_IA", "trigonometricSample_IA", and 
    "trigonometricDerivative_IA". The device function "selectVarInSubRegion" 
    computes the lower and upper bounds for the value of the variable X_num in 
    a specific subregion (defined by “pos”) based on the cycling index of the 
    selected region. Specifically, if the variable is one of the ten variables 
    whose ranges are partitioned, a while loop is used to compute the 
    subinterval index of the specific variable X_num. Otherwise, the device 
    function outputs the corresponding lower and upper bounds for the value of 
    the specific variable X_num from the array that represents the selected 
    region (i.e. the range of the specific variable is not partitioned). 
    ...
    length = 1000 # The number of variables in the Trigonometric function
...
def sampling (region, output_lowestUpper, numSamples, cycIdx):
    ...
    computes the smallest upper bound for the value of the Trigonometric 
    function among all sample points in the selected region to update the upper 
    bound of the global minimum of the Trigonometric function. Specifically, 
    each thread in the same block computes the smallest upper bound for the 
    value of the Trigonometric function among all sample points in its
    corresponding subregion and stores the smallest upper bound on an array on 
    GPU shared memory. The smallest element on the array is derived through a 
    reduction tree. The smallest element on the array is used to update the 
    upper bound of the global minimum of the Trigonometric function (stored on 
    GPU global memory) using atomic operations. 
    ...
    The upper bound of the global minimum of the Trigonometric function. The 
    value is initialized by the upper bound of the global minimum of the 
    Trigonometric function derived from the last iteration.  
    ...
    value of the Trigonometric function derived by threads in the same block. 
    The size of the array on GPU shared memory needs to be consistent with the 
    number of threads per block in GPU computing.
    '''
    shr = cuda.shared.array(512, dtype = np.float64)

    # Compute the smallest upper bound for the value of the Trigonometric 
    # function among all sample points in a subregion 
    shr[thr] = trigonometricSample_IA (region, pos, numSamples[0], cycIdx[0])
    ...
    minimum of the Trigonometric function using atomic operations.
    '''
    if thr == 0:
...
def ruleOutGPU (region, result, atomic_index, lowestUpper, lowerBounds, cycIdx):
    ...
    could exist and the lower bounds for the value of the Trigonometric function 
    in these remaining subregions. The index of each subregion is represented by 
    ...
    "trigonometricValue_IA" which rules out suboptimal subregions through 
    computing the lower bound for the value of the function. Then, the device 
    function "trigonometricDerivative_IA" is called to further rule out 
    suboptimal subregions through computing the first order derivatives of the 
    function. Specifically, the flag equals 0 if the subregion is not ruled out. 
    The flag equals 1 if the subregion is ruled out. 
    ...
    the global minimum of the Trigonometric function F(X). This array is 
    initialized before the execution of the kernel function. 
    ...
    The array stores the lower bounds for the value of the Trigonometric 
    function in the subregions that are not ruled out.
    ...
    fMin, flag = trigonometricValue_IA(region,pos,lowestUpper[0],flag,cycIdx[0])
    # NOTE: Comment OUT the line if do NOT use derivative rule-out
    flag = trigonometricDerivative_IA (region, pos, flag, cycIdx[0])
    if flag == 0:
...
def completeRegion (xVal, pos, cycleIdx):
    ...
    # the value of all variables X_i in the subregion in the Trigonometric 
    # function
...
# the 1000 variables in the Trigonometric function. 

initialRegion = np.tile([-10, 10], 1000)
...
# Initialize the maximum cycling index for the Trigonometric function with 1000 
# variables
maximumCyc = 991
...
# to each region that may include the global minimum of the Trigonometric 
# function)
...
# the global minimum of the Trigonometric function F(X)
widthTolerance = 1e-4
...
# Print the number of variables for the Trigonometric function, width tolerance 
# and the number of samples for the sampling process
print("\n ---------------------------------------------------------------")
print("Number of variables for the Trigonometric function:", 1000)
...
while (terminate == False):
    ...
    # and update the upper bound of the global minimum of the Trigonometric 
    # function using the smallest upper bound for the value of the Trigonometric 
    ...
    # Transfer the upper bound of the global minimum of the Trigonometric 
    # function onto GPU global memory
    ...
    # Update the upper bound of the global minimum of the Trigonometric function 
    ...
    # possibly containing the global minimum of the Trigonometric function F(X))
    ...
    # value of the Trigonometric function in the subregions that could contain 
    # the global minimum 
    ...
    # bound of the global minimum of the Trigonometric function F(X) computed 
    # from the FIRST kernel function.
    ...
    # the values of the Trigonometric function from GPU to CPU
    ...
    # contain the global minimum of the Trigonometric function by appending the 
    # corresponding information of the subregions that are not ruled out (lower 
    # bounds for the value of the Trigonometric function in the current 
    # iteration, the index of the current iteration, the cycling index of the 
    # selected region, and the absolute positions of threads in the grid) after 
    # the CPU or GPU rule-out process.
    ...
    # The region with the smallest lower bound for the value of the 
    # Trigonometric function among all regions in the region list is selected 
    # and then removed from the region list. If the width in each dimension of 
    # the selected region is smaller than the user-defined width tolerance, the 
    ...
    if (lengthList != 0):
        while (found == False):
            ...
            # Obtain the lower bound for the value of the Trigonometric function 
            ...
            # Note: For the Trigonometric function with MORE THAN 10 variables, 
            # the width for each variable should be the same ONLY when the 
            # cycling index of the selected region at the current iteration 
            # equals the maximum cycling index.
