...
'''
Python script "corrupted100.py” finds the global minimum of the Multimodal 
...
the Multimodal Corrupted Convex Quadratic function is set as 100 in this 
script. In other words, the Multimodal Corrupted Convex Quadratic function has 
100 variables, and the value of each variable belongs to the range [-10, 11]. 
...
# the 100 variables in the Multimodal Corrupted Convex Quadratic function. 

initialRegion = np.tile([-10, 11], 100)
...
# Quadratic function with 100 variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Multimodal Corrupted Convex Quadratic function:", 100)
