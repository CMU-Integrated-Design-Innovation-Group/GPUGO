...
'''
Python script "IAGriewank.py” implements the basic interval arithmetic 
operations on GPU-based devices for interval evaluation of the Griewank 
Function [1].
...
Reference:
[1] Griewank, A. O. 1981. Generalized Descent for Global Optimization. J. Optim. 
Theory Appl. 34(1), 11-39.
