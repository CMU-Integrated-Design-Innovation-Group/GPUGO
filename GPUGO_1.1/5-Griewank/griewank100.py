...
'''
Python script "griewank100.py” finds the global minimum of the Griewank 
...
Griewank function is set as 100 in this script. In other words, the Griewank 
function has 100 variables, and the value of each variable belongs to the range 
[-100, 110].
...
def griewankValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 100 # The number of variables in the Griewank function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 100 # The number of variables in the Griewank function
...
# the 100 variables in the Griewank function. 

initialRegion = np.tile([-100, 110], 100)
...
# Initialize the maximum cycling index for the Griewank function with 100 
# variables
maximumCyc = 91
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Griewank function:", 100)
