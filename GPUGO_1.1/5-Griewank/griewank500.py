...
'''
Python script "griewank500.py” finds the global minimum of the Griewank 
...
Griewank function is set as 500 in this script. In other words, the Griewank 
function has 500 variables, and the value of each variable belongs to the range 
[-100, 110].
...
def griewankValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 500 # The number of variables in the Griewank function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 500 # The number of variables in the Griewank function
...
# the 500 variables in the Griewank function. 

initialRegion = np.tile([-100, 110], 500)
...
# Initialize the maximum cycling index for the Griewank function with 500 
# variables
maximumCyc = 491
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Griewank function:", 500)
