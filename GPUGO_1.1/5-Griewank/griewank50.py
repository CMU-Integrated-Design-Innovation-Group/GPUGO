...
'''
Python script "griewank50.py” finds the global minimum of the Griewank 
...
Griewank function is set as 50 in this script. In other words, the Griewank 
...
def griewankValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 50 # The number of variables in the Griewank function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 50 # The number of variables in the Griewank function
...
# the 50 variables in the Griewank function. 
...
# Initialize the maximum cycling index for the Griewank function with 50 
# variables
maximumCyc = 41
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Griewank function:", 50)
