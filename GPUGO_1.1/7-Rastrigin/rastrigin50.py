...
'''
Python script "rastrigin50.py” finds the global minimum of the Rastrigin 
...
Rastrigin function is set as 50 in this script. In other words, the Rastrigin 
...
When the iterative process is halted, the 50-dimensional region(s) that satisfy 
...
def rastriginValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    n = 50 # The number of variables in the Rastrigin function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 50 # The number of variables in the Rastrigin function
...
# the 50 variables in the Rastrigin function. 

initialRegion = np.tile([-5.5, 6], 50)
...
# Initialize the maximum cycling index for the Rastrigin function with 50 
# variables
maximumCyc = 41
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Rastrigin function:", 50)
