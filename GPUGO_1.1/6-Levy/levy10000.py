...
'''
Python script "Levy10000.py” finds the global minimum of the Levy function using 
a GPU-based global optimization method. The Levy function F(X) is introduced as 
the Equation (15) in the paper written by Levy and Montalvo [1]. The Levy 
function has 10 variables (n = 10000) in this script, and the value of each 
...
def LevyValue_IA (xValIA, pos, minUpper, flag, cycleIdx):
    ...
    function F(X), where i belongs to {1, 2, …, n}. In this script, n = 10000.
    ...
    n = 10000 # The number of variables in the Levy function
...
def selectVarInSubRegion (xVal, num, pos, cycleIdx):
    ...
    length = 10000 # The number of variables in the Levy function
...
def ruleOutGPU (region, result, atomic_index, lowestUpper, lowerBounds, cycIdx):
    ...
    the function F(X), where i belongs to {1, 2, …, n}. In this script, 
    n = 10000.
...
# Define a NumPy array that represents the 10000-dimensional search domain. 
# The NumPy array is initialized by the lower and upper bounds for the value of 
# the 10000 variables in the Levy function. 

initialRegion = np.tile([-10, 10], 10000)
...
# Initialize the maximum cycling index for the Levy function with 10000 variables
maximumCyc = 9991
...
print("\n ---------------------------------------------------------------")
print("Number of variables for the Levy function:", 10000)
